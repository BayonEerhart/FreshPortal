    ...
    <table class="table  table-borderless rounded-table ">
        ...
        <tbody>
            ...
            <tr class="rounded-3 table-secondary">
                ...
                <td>
                    <div>
                        <button type="button" class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#edit-<?=  $data[$i][0]?>"><img src="pictures/pencilIcon.png" alt="pencilIcon.png" srcset="pictures/pencilIcon.png" class=" small-img"></button>
